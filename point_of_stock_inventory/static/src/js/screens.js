...
function openerp_posi_screens(instance, module){ //module is instance.point_of_sale
        ...
        start: function(){ //FIXME this should work as renderElement... but then the categories aren't properly set. explore why
            ...
            this.product_list_widget = new module.ProductListWidget(this,{
                click_product_action: function(product){
                    ...
                    $('.pos-leftpane').css('display', 'inline');
//                    $('#myTab').click(function (e) {
//                        alert('aki');
////                         e.preventDefault();
////                         $(this).tab('show');
//                    });
                    self.pos_widget.productleftactwidget.set_product(product);
                    self.pos_widget.productleftactwidget.renderElement();
                    self.pos_widget.productleftactwidget.show();
